        ...
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link js-scroll-trigger" href="<?= site_url('user/about')?>">About <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 d-flex justify-content-center mb-5">
                <img src="../assets/img/logo.jpg" alt="logo" width="600">
            </div>
            <div class="col-lg-6 d-flex justify-content-center mb-5">
            <br>
            Kebun Cakra Makmur (PT Cakra Wadana Indah) didirikian pada tanggal 6 Juni 2020 yang bergerak dibidang pertanian
            <br><br>
            Kebun Cakra Makmur memiliki kemampuan yang sudah teruji oleh pengalaman dan memiliki integritas yang tinggi. Hal ini terbangun baik dalam kerjasama baik dengan pemerintah dan perusahaan di dalam negeri maupun di luar negeri
            <br><br>
            Visi:
            <br><br>
            Misi:
