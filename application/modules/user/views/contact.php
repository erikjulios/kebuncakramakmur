  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link js-scroll-trigger" href="<?= site_url('user/contact')?>">Contact <span class="sr-only">(current)</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31126.909560223416!2d107.0045136!3d-6.633526!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b0ab040f4031%3A0x549b22774d24e6ef!2sWargajaya%2C%20Sukamakmur%2C%20Bogor%2C%20Jawa%20Barat!5e1!3m2!1sid!2sid!4v1607314169309!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
            ...
            <ul class="list-unstyled">
              ...
              <a class="btn-floating btn-wa mx-1" href="#">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">085771017618 / 085720929434</h5>
                </div>
              </li>
              <li class="media my-4">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">kebun_cakramakmur</h5>
                </div>
              </li>
              <li class="media">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">cakrawadanaindah@gmail.com</h5>
                </div>
              </li>
            </ul>
            </div>
    ...
    <footer class="page-footer font-small teal pt-4">
        ...
        <div class="container">
            ...
            <ul class="list-unstyled list-inline text-center">
              ...
              <li class="list-inline-item">
                <a class="btn-floating btn-wa mx-1" href="https://www.kebuncakramakmur.com/">
